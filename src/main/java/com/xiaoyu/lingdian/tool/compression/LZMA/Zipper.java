...
public class Zipper {
    ...
    public void encode(ByteArrayInputStream inputStream, ByteArrayOutputStream outputStream, long len) throws Exception {
        com.xiaoyu.lingdian.tool.compression.LZMA.Encoder encoder = new com.xiaoyu.lingdian.tool.compression.LZMA.Encoder();
        //设置压缩参数。默认即可
    ...
    public void decode(ByteArrayInputStream inputStream, ByteArrayOutputStream outputStream) throws Exception {
        com.xiaoyu.lingdian.tool.compression.LZMA.Decoder decoder = new com.xiaoyu.lingdian.tool.compression.LZMA.Decoder();
        //先读取5bytes设置
