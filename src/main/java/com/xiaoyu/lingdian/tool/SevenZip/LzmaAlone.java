package com.xiaoyu.lingdian.tool.SevenZip;
...
public class LzmaAlone
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		if (params.Command == CommandLine.kBenchmak)
		{
			...
			com.xiaoyu.lingdian.tool.SevenZip.LzmaBench.LzmaBenchmark(params.NumBenchmarkPasses, dictionary);
		}
		else if (params.Command == CommandLine.kEncode || params.Command == CommandLine.kDecode)
		{
			...
			{
				com.xiaoyu.lingdian.tool.SevenZip.Compression.LZMA.Encoder encoder = new com.xiaoyu.lingdian.tool.SevenZip.Compression.LZMA.Encoder();
			...
			else
			{
				...
				com.xiaoyu.lingdian.tool.SevenZip.Compression.LZMA.Decoder decoder = new com.xiaoyu.lingdian.tool.SevenZip.Compression.LZMA.Decoder();
