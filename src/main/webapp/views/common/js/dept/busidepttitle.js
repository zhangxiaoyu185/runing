$(function () {
	...
	$("body").delegate(".delthese","click",function(){
		...
		if(ids == ""){
			...
			if (r==true){
				...
				getOData(str,"busiDeptTitle/delete/batch",{fn:function(oData){
						var obj = {};//查询条件对象
						searchContent(obj);
	...
	$("body").delegate(".delit","click",function(){
		...
		if (r==true){
			...
			getOData(str,"busiDeptTitle/delete/one",{fn:function(oData){
					var obj = {};//查询条件对象
					searchContent(obj);
					pagenum = parseInt($(".curpage").text());
					isNull(obj,pagenum);
...
function showList(obj,pagenum){
	...
	var str = 'pageNum='+pagenum+'&pageSize=15';
		...
		getOData(str,"busiDeptTitle/find/by/cnd",{fn:function(oData){
		var strhtml_list = "";
